...
<map name="map">
  <area
    shape="poly"
    alt="IP-1"
    coords="94,16,94,19,122,39,118,66,135,108,135,133,126,145,129,151,112,162,
            106,172,91,209,103,209,116,213,118,208,129,208,135,188,143,182,
            142,17"
    href="/conductivity/IP-1" />
  <area
    shape="poly"
    alt="CL-1"
    coords="0,124,0,175,18,188,35,183,43,155,29,142,37,128,33,111,13,108"
    href="/conductivity/CL-1" />
  <area
    shape="poly"
    alt="IP-2"
    coords="81,14,78,93,88,93,92,14"
...
<a href="IP-4.png">
  <img src="IP-4_browser.png"
    alt="1D Resistivity Model for Interior Plains (Great Plains) Model IP-4"
    width="650" height="442" />
</a>
