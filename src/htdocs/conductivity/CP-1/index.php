...
<div class="column container contains-twelve">
	...
	<div class="nine column">
		<center><h3>1D Resistivity Model for Coastal Plains (South Carolina) Model CP-1</h3></center>
...
<area shape="poly" alt="AP-1" coords="1,151,1,132,12,127,56,32,55,7,100,30,91,58,40,90,25,124" href="/conductivity/AP-1" />
	...
	<div class="three column">
		<h2>Location</h2>
		<img src="locationsCP1.png" width="224" height="247" alt="Location of CP-1" style="margin-top:-10px;" usemap="#map">
	</div>
