...
<map name="map">
  <area
    shape="poly"
    alt="IP-3"
    coords="69,46,1,61,0,47,6,53,18,48,21,21,16,1,66,2,75,15,74,28,64,38"
    href="/conductivity/IP-3" />
  <area
    shape="poly"
    alt="AP-1"
    coords="83,66,132,90,123,110,123,120,67,154,67,161,57,167,52,179,53,194,
            22,224,13,196,35,198,35,191,49,168,49,157,74,114,83,90"
    href="/conductivity/AP-1" />
  <area
    shape="poly"
    alt="CP-2"
    coords="107,211,132,235,124,254,130,277,97,286,84,280,68,290,43,278,2,283,
            2,186,12,198,20,225,37,232,74,232,95,220"
    href="/conductivity/CP-2" />
  <area
    shape="poly"
    alt="CP-1"
    coords="110,210,133,232,154,211,191,211,190,197,163,197,202,152,176,76,
            170,86,175,136"
    href="/conductivity/CP-1" />
  <area
    shape="poly"
    alt="AP-2"
    coords="82,62,135,87,140,73,142,50,161,35,189,36,201,2,157,1,120,17"
...
<a href="PT-1.png">
  <img src="PT-1_browser.png"
    alt="1D Resistivity Model for Piedmont (SE Appalachians) Model PT-1"
