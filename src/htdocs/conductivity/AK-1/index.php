...
<map name="map">
  <area
    shape="poly"
    alt="IP-3"
    coords="79,161,79,151,84,146,87,129,82,121,70,110,71,96,49,82,58,75,46,
            67,14,72,15,96,0,110,2,150,11,161"
    href="/conductivity/IP-3" />
  <area
    shape="poly"
    alt="AP-2"
    coords="163,160,176,151,199,152,213,132,212,120,206,112,186,116,148,131,
            137,136,120,160"
    href="/conductivity/AP-2" />
  <area
    shape="poly"
    alt="SL-1"
    coords="145,129,198,110,183,95,184,86,207,78,207,72,145,77,145,98,175,97,
            174,113,139,119"
    href="/conductivity/SL-1" />
  <area
    shape="poly"
    alt="NE-1"
    coords="219,130,206,155,269,126,253,111,259,88,309,88,309,72,277,72,298,
            52,288,42,248,72,248,120"
    href="/conductivity/NE-1" />
</map>

<figure class="right">
  <img src="locationsAK1.png" alt="Location of AK1" width="304"
...
<ul>
  <li>
    <a target="_blank"
      href="ftp://hazards.cr.usgs.gov/Rigler/Conductivity_Latest/earth_model_AK1A.txt">
      earth_model_AK1A.txt
    </a>
  </li>
  <li>
    <a target="_blank"
      href="ftp://hazards.cr.usgs.gov/Rigler/Conductivity_Latest/earth_model_AK1B.txt">
