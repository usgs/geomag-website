...
<h3>Introduction</h3>
<p>
  The United States Geological Survey maintains a geomagnetic observatory in
  Sitka, Alaska. This observatory is tasked with continually monitoring the
...
<p>
  The US Geological Survey (USGS) is preparing an Environmental Assessment to
  disclose the potential effects of removing a concrete structure within the
  boundary of the Geomagnetic Observatory on Geodetic Way in Sitka.
</p>
<p>
...
<p>
  ...
  when it became part of the USGS Geomagnetic Program. The withdrawn area
  includes seven structures (six wood framed buildings and the seismic vault)
...
<figure class="left">
  ...
  <figcaption>
    <b>Figure 2.</b> <i>Seismic vault floor plan showing the concrete piers
    that will be protected and preserved during demolition and construction.
    </i>
  </figcaption>
</figure>
...
<figure class="center">
  <img src="images/seismic_vault_cross_section3.png"
  alt="Seismic vault cross section." />
  <figcaption>
    <b>Figure 3.</b> <i>Seismic vault cross section showing the layout of the
    structure.</i>
  </figcaption>
</figure>
...
<figcaption>
  <b>Figure 4.</b> <i>Pictures of seismograph vault roof and front (north)
  entrance.</i>
</figcaption>

<h3>Purpose and Need for Action</h3>
<p>
  The purpose and need for the proposed action is to remove an unsafe structure
...
<p>
  Based on the analysis in the Environmental Assessment, the USGS Responsible
  Official will determine if the preferred alternative will have a significant
  impact on the quality of the human environment.  If there is no significant
  impact, the USGS will issue a Finding of No Significant Impact (FONSI) and
  make a final decision regarding whether or not to proceed with the project on
  the basis of agency mission, legal mandates and public comment on the draft
  EA.
</p>
<p>
...
<dl class="no-style">
  <dt>U.S. Geological Survey</dt>
    <dd>
      Geomagnetism Group<br />
      PO Box 25046, MS 966<br />
      Denver, CO 80225<br />
      email:  sitka_EA@usgs.gov
    </dd>
</dl>

<h3>
  Specific questions can also be directed to any of the following individuals:
</h3>

<dl class="no-style">
  <dt>Carol Finn</dt>
    <dd>
      USGS Geomagnetism Group Leader<br />
      Phone:  303-273-8475<br />
      Email:  cafinn@usgs.gov
    </dd>
  <dt>Donna Seaman</dt>
    <dd>
      USGS Regional Environmental Protection Specialist<br />
      Phone:  916-278-9436<br />
      Email:  dseaman@usgs.gov
    </dd>
  <dt>Dennis Rogers</dt>
    <dd>
      Rogers Environmental<br />
      Phone: 256-435-6468<br />
      e-mail: djrogers@acsalaska.net
    </dd>
</dl>
